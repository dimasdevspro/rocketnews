...
<p>Projeto proposto pela escola Rocketseat, no curso Discovery, para desenvolver uma página de coleta de leads.</p>
...
$ git clone https://github.com/dimasdevspro/rocketnews
